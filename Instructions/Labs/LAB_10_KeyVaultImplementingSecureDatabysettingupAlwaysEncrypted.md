...
1. 在 **“sqlApp | 证书和机密”** 边栏选项卡上，识别 **“Key1”** 的值。
...
1. 返回到控制台应用程序，此处会提示你输入有效的 SSN。这将查询加密列中的数据。在“命令提示符”处，键入以下内容，然后按 Enter 键：
